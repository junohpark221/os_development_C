...
#define SYS_GETSTAT   ( 0x08 )
#define SYS_SETSTAT   ( 0x09 )
#define SYS_GETMUT    ( 0x0a )
#define SYS_SETMUT    ( 0x0b )
#define SYS_GETPID    ( 0x0c )
#define SYS_SETPID    ( 0x0d )
#define SYS_GETPIDM   ( 0x0e )
#define SYS_SETPIDM   ( 0x0f )
#define SYS_GETSTATEM ( 0x10 )
#define SYS_SETSTATEM ( 0x11 )
...
// return one of the phil_status1 or phil_status2 which is appropriate for the process.
extern unsigned int getstat(int local_pid);
// set new status value at which that part was modifieded.
extern void setstat(unsigned int state, int local_pid);

// return the mutex
extern int getmut();
// set the mutex as process's local_pid.
extern void setmut(int mutex);

// return the local_pid of the process
extern int getpid();
// set new local_pid for the process
extern void setpid(int pid);

// return the pid_mutex.
extern int getpidm();
// set the pid_mutex as process's local_pid.
extern void setpidm(int mutex);

// return the state_mutex.
extern int getstatem();
// set the state_mutex as process's local_pid.
extern void setstatem(int mutex);
#endif
